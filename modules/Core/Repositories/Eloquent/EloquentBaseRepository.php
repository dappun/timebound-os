<?php namespace TB\Core\Repositories\Eloquent;

use Illuminate\Database\Eloquent\Builder;
use TB\Core\Repositories\BaseRepository;
...
abstract class EloquentBaseRepository implements BaseRepository
{
    ...
    public function options($userId, $format = 'array', $allowEmpty = false)
    {
        $active = $this->activeAll()->all();
        if ($allowEmpty) {
            $text = 'Select';
            if (is_string($allowEmpty)) {
                $text = $allowEmpty;
            } else if (isset($this->singularName)) {
                $text .= ' a ' . $this->singularName;
            }
